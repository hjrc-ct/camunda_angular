...
@Component({
  selector: 'registrarDataTask',
  templateUrl: './registrarDataTask.component.html',
  styleUrls: [],
  providers: [ CamundaRestService, HttpClientModule],
  exportAs: 'registrarDataTask'
})
export class registrarDataTaskComponent extends CompleteTaskComponent {
  NgForm = NgForm;

  override model     : RegistrarData = new RegistrarData('123','Description', 0, 'Observations');
  ...
  constructor(route: ActivatedRoute,
    ...
    this.route.params.subscribe(params => {
      ...
      if ("true" === this.parentIdFlag ) {
            ...
            this.camundaRestService.getTask(environment.taskType_Registrar, params['id'] )
              .subscribe( (result) => { 
